...
class SalasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val salas = listOf<Sala>(
            ...
            Sala("Sala 2", R.mipmap.imagen_sala1,"Sala 2 es una sala de karaoke con capacidad de hasta 5 personas. Dispone de 4 micrófonos y una pantalla de 50 pulgadas. Excelente para disfrutar del karaoke por un precio reducido.", "4", "4", "Si"),
